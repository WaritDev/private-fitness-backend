...
func init() {
	Migrations = append(Migrations, createCustomerDurations)
}

var createCustomerDurations = &Migration{
	Title: "20251030011528_create_customer_durations.go",
	...
	Down: func(db *sql.DB) error {
		_, err := db.ExecContext(context.Background(), `
		DROP TABLE IF EXISTS customer_durations;
		`)
		if err != nil {
			return err
		}
